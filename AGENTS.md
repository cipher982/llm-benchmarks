...
```bash
mongosh "mongodb://writer:copybook-wallow-sawfish@5.161.97.53/llm-bench?authSource=llm-bench" --eval '
db.models.insertOne({
  provider: "bedrock",
...
mongosh "mongodb://writer:copybook-wallow-sawfish@5.161.97.53/llm-bench?authSource=llm-bench" --quiet --eval '
